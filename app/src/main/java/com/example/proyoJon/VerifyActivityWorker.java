...
public class VerifyActivityWorker extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_verify_worker);
        ...
        mAuth.signInWithCredential(credential).addOnCompleteListener(new OnCompleteListener<AuthResult>() {
            ...
            public void onComplete(@NonNull Task<AuthResult> task) {
                if(task.isSuccessful()){
                        Intent intent = new Intent(VerifyActivityWorker.this,SignupActivity.class);
                    ...
                    Toast.makeText(VerifyActivityWorker.this, task.getException().toString(), Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private PhoneAuthProvider.OnVerificationStateChangedCallbacks
        ...
        public void onVerificationFailed(FirebaseException e) {
            Toast.makeText(VerifyActivityWorker.this, e.getMessage(), Toast.LENGTH_SHORT).show();
        }
    };
